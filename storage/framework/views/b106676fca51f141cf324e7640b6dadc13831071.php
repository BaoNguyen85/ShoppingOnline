                ...
                <div class="panel-body">
                    ...
                    <div class="position-center">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="product_slug" class="form-control" id="exampleInputEmail1" value="<?php echo e($pro->product_slug); ?> placeholder="Slug">
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            <textarea style="resize:none" rows="8" class="form-control" name="product_desc" id="ckeditor"><?php echo e($pro->product_desc); ?></textarea>
                        </div>
                        <div class="form-group">
                            <label for="exampleInputPassword1">Nội dung sản phẩm</label>
                            <textarea style="resize:none" rows="8" class="form-control" name="product_content" id="ckeditor1"><?php echo e($pro->product_content); ?></textarea>
                        </div>
                        <div class="form-group">
...
<?php echo $__env->make('admin_layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\XAMPP\htdocs\shopping\resources\views/admin/edit_product.blade.php ENDPATH**/ ?>