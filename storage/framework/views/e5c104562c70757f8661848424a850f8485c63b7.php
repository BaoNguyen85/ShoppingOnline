...
<div class="w3layouts-main" style="background-image: linear-gradient(60deg, #3d3393 0%, #2b76b9 37%, #2cacd1 65%, #35eb93 100%);border-top-left-radius: 20px;border-top-right-radius: 20px;border-bottom-left-radius: 20px;border-bottom-right-radius: 20px;">
	...
	?>
		<form action="<?php echo e(URL::to ('/register')); ?>" method="post">
            ...
            <input type="text" class="ggg" name="admin_name" value="<?php echo e(old('admin_name')); ?>" placeholder="Điền Name" required="">
			<input type="text" class="ggg" name="admin_email" placeholder="Điền Email" required="">
            <input type="text" class="ggg" name="admin_phone" value="<?php echo e(old('admin_phone')); ?>" placeholder="Điền Phone" required="">
		...
		<a href="<?php echo e(url('/login-google')); ?>">Đăng nhập Google</a> |
		<a href="<?php echo e(url('/register-auth')); ?>">Đăng ký Auth</a> |
        <a href="<?php echo e(url('/login-auth')); ?>">Đăng nhập Auth</a>
</div>
</div>
...
<?php /**PATH D:\XAMPP\htdocs\shopping\resources\views/admin/custom_auth/register.blade.php ENDPATH**/ ?>