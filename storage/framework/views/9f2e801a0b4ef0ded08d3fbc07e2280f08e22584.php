          ...
          <?php $__currentLoopData = $admin; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $user): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <form action="<?php echo e(url('/assign-roles')); ?>" method="POST">
              ...
              <td>
                ...
                <p><a style="margin:5px" class="btn tbn-sm btn-danger" href="<?php echo e(url('delete-user-roles/'.$user->admin_id)); ?>">Xóa user</a></p>
              </td> 
...
<?php echo $__env->make('admin_layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\XAMPP\htdocs\shopping\resources\views/admin/users/all_users.blade.php ENDPATH**/ ?>