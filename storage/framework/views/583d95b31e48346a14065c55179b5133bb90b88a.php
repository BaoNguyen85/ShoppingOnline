...
<link href="<?php echo e(('public/backend/css/font-awesome.css')); ?>" rel="stylesheet"> 
    ...
    <ul class="nav pull-right top-menu">
        ...
        <li class="dropdown">
            <a data-toggle="dropdown" class="dropdown-toggle" href="#">
                <img alt="" src="<?php echo e(asset ('public/backend/images/4.jpg')); ?>">
                <span class="username">
					<?php
    ...
    <div id="sidebar" class="nav-collapse">
        ...
        <div class="leftside-navigation">
            <ul class="sidebar-menu" id="nav-accordion">
				...
				<li>
                    <a href="<?php echo e(URL::to('/information')); ?>">
                        <i class="fa fa-dashboard"></i>
				...
				<li class="sub-menu">
                    ...
                    <ul class="sub">
						<li><a href="<?php echo e(URL::to('/add-category-post')); ?>">Thêm danh mục bài viết</a></li>
						<li><a href="<?php echo e(URL::to('/all-category-post')); ?>">Liệt kê danh mục bài viết</a></li>
                    </ul>
                </li>
				<li class="sub-menu">
                    <a href="javascript:;">
				...
				<li class="sub-menu">
                    ...
                    <ul class="sub">
						<li><a href="<?php echo e(URL::to('/add-users')); ?>">Thêm users</a></li>
				...
				<li class="sub-menu">
                    ...
                    <ul class="sub">
						...
						<li><a href="<?php echo e(URL::to('/all-post')); ?>">Liệt kê bài viết</a></li>
                    </ul>
                </li>
...
<?php /**PATH D:\XAMPP\htdocs\shopping\resources\views/admin_layout.blade.php ENDPATH**/ ?>