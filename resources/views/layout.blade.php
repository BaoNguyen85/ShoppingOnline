					...
					<div class="col-sm-8">
						<div class="shop-menu pull-right">
							{{-- <ul class="nav navbar-nav"> --}}
								...
								?>
								{{-- <li style="list-style: none"> --}}
									<a style="color: #ffffff" href="{{ URL::to('/checkout') }}"><i class="fa fa-crosshairs"></i> Thanh toán</a> &emsp;
								{{-- </li> --}}
								<?php
								...
								{{-- <li style="list-style: none"> --}}
									<a style="color: #ffffff" href="{{ URL::to('/payment') }}"><i class="fa fa-crosshairs"></i> Thanh toán</a> &emsp;
								{{-- </li> --}}
								<?php
									}else{
								?>
								{{-- <li style="list-style: none"> --}}
									<a style="color: #ffffff" href="{{ URL::to('/dang-nhap') }}"><i class="fa fa-crosshairs"></i> Thanh toán</a> &emsp;
								{{-- </li> --}}
								<?php
									}
								?>
								...
								{{-- <li style="list-style: none"> --}}
									...
									<a style="color: #ffffff" href="{{ URL::to('/gio-hang') }}"><i class="fa fa-shopping-cart"></i> Giỏ hàng</a> &emsp;
								...
								?>
								{{-- <li style="list-style: none"> --}}
									<a style="color: #ffffff" href="{{ URL::to('/dang-nhap') }}"><i class="fa fa-sign-in"></i> Đăng nhập</a> &emsp;
								{{-- </li> --}}
								<?php
									}
								?>
